...
const options: ModelSelectorOption[] = [
    ...
    {
        // The only model with a single precision build, so it takes the whole row rather than leaving a gap.
        value: 'osaka_fp16',
        label: 'Osaka',
        fullWidth: true,
        description:
            'A diffusion model that rebuilds detail instead of interpolating it, giving the most dramatic results on soft, small, or heavily compressed photos. It is in a different league for cost: a 7.3 GB download on first use, roughly 8 GB of GPU memory, and far slower than the other models — minutes rather than seconds on a good GPU, and impractically slow without one.',
    },
];
